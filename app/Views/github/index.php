            ...
            <div class="table-container">
                <table class="table is-fullwidth">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $favorite['vtuber_name'] ?></td>
                            <td><?= $favorite['vtuber_description'] ?></td>
                            <td>
                                <a href="<?= base_url('favorites/edit/') . $favorite['id'] ?>" class="edit-container button is-link">Edit</a>
                                <form style="display:inline" action="<?= base_url('favorites/delete/') . $favorite['id'] ?>" method="post">
